var testdatalen = testdata.e.length;
var addiindex = 0;
...
window.onload = function() {
    ...
    var h = new commit_history(svg);

    for (addiindex = 0; addiindex < testdatalen; addiindex++) {
        var e = testdata.e[addiindex++];
        if (!'c' in e)
            continue;
        h.add_one_commit(e);
    }
    svg.attr("height", h.commits.length*16);
